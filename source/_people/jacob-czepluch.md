...
description: ETHDEV intern and Copenhagen Ethereum Meetup founder
start: Aug 2015
end: Dec 2015
...
Jacob Czepluch was an intern at ETHDEV in Berlin during the tumultuous period following Ethereum's mainnet launch. A fly-on-the-wall during the funding crisis that would reshape the Foundation, he also founded the [Copenhagen Ethereum Meetup](https://www.meetup.com/Copenhagen-Ethereum-Meetup/) in July 2015—which he has run for over 10 years.
...
In spring 2015, Jacob and two friends—Nikolaj Zangenberg Lollike and Simon Oliver Malone—wrote their bachelor thesis on blockchain technology, focusing on Ethereum. The small size of the ecosystem meant direct contact with the [Ethereum Foundation](/articles/stiftung-ethereum/):
...
Jacob arrived at the Berlin office in August 2015, originally planning to work on the C++ team in London. But the [Foundation](/articles/stiftung-ethereum/)'s funding crisis intervened:
...
Instead, he joined the [Python client](/articles/pyethereum) team in Berlin, starting just weeks after mainnet launched. His second day coincided with the first major consensus bug—a chain split between Geth and the C++/Python clients:
...
Jacob attended [DEVCON1](/articles/devcon1/) in London in November 2015, an experience that transformed his career trajectory:
...
Jacob was also involved with the [Raiden Network](/articles/raiden/), which received positive feedback at the conference.
...
This profile draws from [Jacob Czepluch's Early Days of Ethereum interview](/videos/episode007-jacob-czepluch/), which provides first-hand accounts of the Berlin office during the Foundation's funding crisis and the formative DEVCON1 experience.
