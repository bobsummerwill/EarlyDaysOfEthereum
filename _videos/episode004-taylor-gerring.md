...
I want to also put in, before I end to Bob, we should, before we let Taylor go, talk a little bit about the ["Red Wedding"]({{ '/articles/red-wedding/' | relative_url }}). But I'll throw it to Bob on this question.
