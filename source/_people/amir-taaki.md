...
Amir became one of the first five Bitcoin developers listed on bitcoin.org. He created [Libbitcoin](https://libbitcoin.info/) in 2011, an alternative Bitcoin implementation that remains active today under [Eric Voskuil](https://x.com/evoskuil)'s leadership.

He also created the BIP (Bitcoin Improvement Proposal) system, motivated by concerns about [Gavin Andresen](https://en.wikipedia.org/wiki/Gavin_Andresen)'s approach to Bitcoin development:
...
> "So then that's when [Vitalik](/people/vitalik-buterin/) started to become interested in those ideas."
...
Dark Market later became [OpenBazaar](https://github.com/OpenBazaar).

## Syria and Beyond

In 2015, Amir [traveled to Syria](https://www.bbc.com/news/uk-39417937) to fight with the YPG (Kurdish People's Protection Units) against ISIS. During his absence, Dark Wallet development "fizzled out":
...
Amir's current project is [DarkFi](https://dark.fi), an L1 blockchain with anonymous smart contracts using zero-knowledge proofs:
...
{% include content-embed.html
  ...
  description="Early interview with Vitalik filmed by Amir at the hack lab"
  author="BoxxyBrassin"
  date="2013-08-31"
  site="YouTube"
%}
...
- [Amir's old YouTube channel](https://www.youtube.com/@BoxxyBrassin)
- [Old UnSystem Wiki (archived)](https://web.archive.org/web/20150309190939/http://wiki.unsystem.net/en/index.php/Bitlaw)
