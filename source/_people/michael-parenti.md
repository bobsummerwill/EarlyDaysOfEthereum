...
nickname: Exiled Surfer
description: Author of the first tweet about Ethereum
start: Dec 2013
end: present
...
social:
  ...
  linkedin: https://www.linkedin.com/in/michaelparenti/
...
Before Ethereum, Michael worked at the [Bitcoin Foundation](https://en.wikipedia.org/wiki/Bitcoin_Foundation), joining just months before the [Mt. Gox](https://en.wikipedia.org/wiki/Mt._Gox) collapse:
...
In 2021, during the NFT boom, someone suggested Michael mint his historic tweet as an NFT. Initially offered $200, he declined—then minted it anyway and sold it for $21,000, making it the second most expensive tweet ever sold (behind [Jack Dorsey's first tweet](https://v.cent.co/tweet/20)).
...
Michael was present in the early Bitcoin meetup scene, particularly at [Room 77](https://www.bitcoinhistory.net/room-77-became-the-first-brick-and-mortar-business-to-accept-bitcoin-)—Jörg Platzer's bar in Berlin's Kreuzberg district, which was the first brick-and-mortar business to accept Bitcoin and a gathering place for early crypto enthusiasts.
...
He became "resident cypherpunk" at [Status](https://status.im) and got deeply involved with the [Department of Decentralization](https://dod.ngo/), helping to organize ETHBerlin events and participating in the launch of the [Goerli](https://github.com/eth-clients/goerli) testnet:
...
When EDCON was scheduled for Vienna in 2020, Michael planned to use the occasion to launch [Paralelní Polis Vienna](https://www.parallele.at/). When COVID shut everything down, he pivoted to create [NonCon](https://noncon.org/)—a virtual conference:
...
This profile draws from [Michael Parenti's Early Days of Ethereum interview](/videos/episode008-michael-parenti/), which provides first-hand accounts of the pre-Ethereum Bitcoin community and the European crypto scene that surrounded Ethereum's birth.
