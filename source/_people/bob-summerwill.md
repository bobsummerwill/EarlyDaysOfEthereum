---
name: Bob Summerwill
description: Core Developer (C++) and creator of the Early Days of Ethereum project
...
Bob Summerwill was a core developer on Ethereum's [C++ client](/articles/cpp-ethereum/) who later became a bridge builder across the ecosystem—working at the [Enterprise Ethereum Alliance](/articles/enterprise-ethereum-alliance/), Hyperledger, and as Executive Director of the [ETC Cooperative](https://etccooperative.org/). He created the Early Days of Ethereum project to preserve the history of Ethereum's founding.
...
He was hired into the [Ethereum Foundation](/articles/stiftung-ethereum/) in early 2016. His first major contributions were bringing engineering discipline to a chaotic codebase:
...
He created the foundational historical articles—[Ethereum Foundation People](/articles/ethereum-foundation-people/) and [Ethereum Foundation Timeline](/articles/ethereum-foundation-timeline/)—that became sources for Laura Shin's book "The Cryptopians" and other Ethereum histories.

## Later Work

After leaving the Foundation, Bob became a bridge builder across the fragmented blockchain ecosystem:

- **[Enterprise Ethereum Alliance](/articles/enterprise-ethereum-alliance/)**: Working on enterprise adoption
- **Hyperledger**: Cross-chain collaboration
- **[ETC Cooperative](https://etccooperative.org/)**: Executive Director, supporting the Ethereum Classic ecosystem
- **[BlockApps](https://blockapps.net)**: Head of Ecosystem (joined January 2025)
