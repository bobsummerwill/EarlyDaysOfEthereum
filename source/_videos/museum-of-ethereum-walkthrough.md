...
description: "Bob Summerwill and Kieren James-Lubin walk through the Museum of Ethereum at ETHDenver, covering the many hands behind Ethereum's early history, the Foundation's formative eras, ETH Swiss and Miami, and the Ethereum Time Machine demo with Homestead, Geth, Mist, and relic tokens. Thanks to Colin de Picker for filming and A/V production."
...
table_of_contents:
  ...
  - link: "#eth-swiss-miami-genesis"
    title: "ETH Swiss, Miami, and the early foundation"
  ...
  - link: "#mist-demo-relic-tokens"
    title: "Mist demo and relic tokens"
...
**[00:00] Bob Summerwill:** So, hello and welcome to Denver. We're going to have a little walkthrough of the Museum of Ethereum. So I'm Bob Summerwill, head of ecosystem at [STRATO](https://strato.nexus), and here we have

**[00:13] Kieren James-Lubin:** Kieren James-Lubin, CEO at [STRATO](https://strato.nexus).

**[00:15] Bob Summerwill:** Okay. So the Museum of Ethereum's come together over the last few months. It was actually somebody at [ETHDenver](https://ethdenver.com/)'s idea, maybe we'd have a museum. And they ended up contacting me and it's like, oh, you got the content. Great, we can put this together. So it's been a collaboration between myself and Jessica Angel, who is the creative director of Homework. So here we are, here is the museum. We have some lovely CRT TVs here. You see yourself walking around a little bit and then we've got various sort of arty pieces. There's some background Ethereum things. There's a few sort of NFT-ish bits. I don't know what that is. Anyway, in we come.
...
**[04:18] Bob Summerwill:** So you had Kelly Becker here, who [Lars](/people/lars-klawitter/), [Vadim](/people/vadim-levitin/) and [Wayne](/people/wayne-hennessy-barrett/) came in as directors. So Lars worked at Rolls Royce, Vadim at the UN and Wayne was a sort of fintechy guy. And then you also had Ming Chan, who was the first executive director who came in, and Tong, her sister, who I met this morning for the very first time, she was here, was the legal counsel. So [Ming](/people/ming-chan/)'s reign was mixed, shall we say. But we had two and a half years of that where really had a very minimal overhead. It's like [Ming](/people/ming-chan/), Vitalik and the lawyer with a board. And then you had a bunch of devs. So there was very little internal support. The website didn't change for two and a half years. There wasn't even a grant program at all. Put in fire, who became the new ED, and the Infinite Garden began.

So I haven't got really information turned down because it's just too many. It's not really the scope. But then in 2025 you have these changes where [Aya](/people/aya-miyaguchi/) went upstairs and you have the two new co-EDs. So I think the Infinite Garden ended a year ago. People will still use those memes, but we're not in the Infinite Garden anymore. So my title there was "Watermelon CEO," really around [Tomas](/people/tomasz-stanczak/) going, the poetry's nice and all, but how about we check some features. How about we see this as a competitive landscape and you've got to move. So something like privacy. Okay. You've got 40 people in a privacy team actually working on that.

<h3 id="eth-swiss-miami-genesis">ETH Swiss, Miami, and the early foundation</h3>

Ethereum, Ethereum as a company, as the prime sponsor of Bitcoin Expo 2014. So imagine that, a Bitcoin conference, an Ethereum company are the prime sponsor and apparently a thousand T-shirts were given away. They're on the stall, shilling Ethereum. Notably this code on the back was pretty well known but I think is in Mutan but ETH Swiss.

**[06:38] Kieren James-Lubin:** Okay.

**[06:39] Bob Summerwill:** So yeah, ETH Swiss was formed in February 2014 and it was a for-profit company in Switzerland.
...
**[06:51] Bob Summerwill:** Shut down. So yeah, through that period. So you had ETH Swiss which was formed by [Mihai](/people/mihai-alisie/) Alisie and a guy, I forget his name. [Anthony](/people/anthony-di-iorio/) formed Ethereum Canada as well because he, the thought was it would operate out of Toronto. Like Ethereum was, [Vitalik](/people/vitalik-buterin/) was there. Ethereum was one of n projects happening out of [Bitcoin Decentral](https://en.wikipedia.org/wiki/Decentral). That was the plan. But then very rapidly some people, I think mainly around [Charles](/people/charles-hoskinson/), were investigating other jurisdictions and it's like, yes, Switzerland, that's the one. You don't want to come out of North America. It's like Johann Gevers who started, who took his fintech company Monetas to Zug and started Crypto Valley. It was July before the foundation got formed and prior to that you just got these for-profit companies. So [Taylor](/people/taylor-gerring/) was not co-founder of the project but he was a co-founder of the foundation. So when the foundation got formed it was Taylor, [Mihai](/people/mihai-alisie/), and [Vitalik](/people/vitalik-buterin/).

So in 2022 [Taylor](/people/taylor-gerring/) released these onto Twitter. Very shortly into the project it's like, right, we're going to launch Ethereum. So [Vitalik](/people/vitalik-buterin/) was giving his talk, introducing Ethereum, the crowds of people around and afterwards all this excitement. Anthony Di Iorio had rented this house that was kind of a crash zone, hacker zone where many of them got together for the first time. So you got five of the eight here, you got Charles Hoskinson now of [Cardano](https://cardano.org/), Gavin Wood now of [Polkadot](https://polkadot.com/), [Vitalik](/people/vitalik-buterin/), [Anthony](/people/anthony-di-iorio/), Joe Lubin at the back there. And this is Zug gathering and this is another one which is Devcon Zero. So that was October of this year.
...
<h3 id="mist-demo-relic-tokens">Mist demo and relic tokens</h3>
...
**[21:19] Kieren James-Lubin:** But yeah, it's, I think, definitely appropriate here at [ETHDenver](https://ethdenver.com/) and it came together sort of better than I thought it would.
