...
I'm happy to announce that Ian Meikle, the accomplished videographer who co-authored the impressive "Koyaanis-glitchy" Ethereum [brand video](http://vimeo.com/92338385) has been moved to ÐΞV to help with the communications team. He who shall be known only as Texture has also joined the comms side with [Stephan](/people/stephan-tual/) to help with the strategy stateside and coordinate the worldwide meetup and hackathon network. Great to see such a capable and passionate designer on the team; I know he has a good few ideas for ÐApps!

Two more hires under [Stephan](/people/stephan-tual/) in the comms team include [Ken Kappler](http://dappsforbeginners.wordpress.com/), handling the developer education direction, hackathons, ethereum curriculum and university partnerships. George Hallam has also been employed to evangelize ethereum to startups and partners, boost the reach of our formal network and generally help [Stephan](/people/stephan-tual/) in the quest of having everybody know what Ethereum is and how it can help them.
...
Gav ([gavin.nospam.wood@ethdev.com](mailto:gavin.nospam.wood@ethdev.com)).
