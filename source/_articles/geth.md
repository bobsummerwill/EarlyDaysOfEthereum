...
Geth (Go-Ethereum) is the Go-language implementation of the Ethereum protocol. Started by Jeff Wilcke in late 2013, it became the dominant Ethereum client and was the first to pass its security audit ahead of the [Frontier launch](/articles/frontier/) on July 30, 2015.
...
As James Hormuzdiar recalled in [Episode 1](/videos/episode001/), the Go client quietly emerged as the most stable implementation:
