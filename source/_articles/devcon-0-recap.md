...
The first day of ÐΞVcon-0 kicked off early at 7am with the Ethereum UK communications team arriving at the venue (Ethereum Dev GmbH's workspace in Kreuzberg, Berlin) to set up the 4K high quality recording equipment and arrange the space for the event.

After a quick coffee and croissant/pain au chocolat, everyone was ready for the first presentation - "Ethereum ÐΞVcon-0 – Gavin: Welcome! Our mission: ÐApps " which was delivered by Gavin Wood. [Gavin](/people/gavin-wood/) made it very clear within this presentation the need for decentralised applications in today's society with two very powerful opening quotes, "Progress has led to the concentration of power" and "Our mission therefore is decentralisation". Following the presentation on ÐApps, [Gavin](/people/gavin-wood/) invited everyone present to introduce themselves and explain their roles in Ethereum. It was humbling to see how Ethereum has attracted such a [magnificent team](https://web.archive.org/web/20141217093441/https://ethdev.com/#team) of incredibly talented people from such a wide variety of backgrounds.
...
After the workshop, Christoph Jenzsch presented on the why and how of unit testing in the Ethereum project. In his talk, [Christoph](/people/christoph-jentzsch/) described several different types of test that need to be carried out - unit tests, integration tests and system tests. He also explained the different tools available to make it easy for every developer involved in Ethereum to get working on the huge amount of testing that needs to be carried out before it's released.
...
After lunch, [Juan](/people/juan-benet/) Batiz-Benet of Filecoin/IPFS showed the audience the technology behind IPFS and Bitswap. He also presented some Ethereum/IPFS use cases such as content addressed files, IPNS naming and high performance distributed filesystem and tool integration.
