...
Most of us are aware that the current planetary operating system is pushing us into extinction as a species. Finance seems to be the current paradigm humanity has to transcend on its path from a [civilization type zero](https://en.wikipedia.org/wiki/Kardashev_scale#Type_0) into a [civilization type one](https://en.wikipedia.org/wiki/Kardashev_scale#Type_I).
...
{% include content-embed.html
  src="https://web.archive.org/web/2oe_/http://wayback-fakeurl.archive.org/yt/b58SfRphkKc"
  title="Carl Sagan's Famous 'Pale Blue Dot' Quote in Cosmos: A Spacetime Odyssey"
  description="This video was embedded in the original blog post."
%}
