---
name: Mihai Alisie
description: Ethereum co-founder, Bitcoin Magazine co-founder, coined "Crypto Valley"
...
During discussions about the Ethereum Foundation's setup, Mihai suggested the term "[Crypto Valley](/articles/crypto-valley/)" to refer to the Zug region. This name was inspired by the area's emerging cluster of Bitcoin and blockchain firms, and it became the globally recognized brand for Switzerland's blockchain ecosystem.

## The Ethereum Project Vision

Mihai authored "[The Ethereum Project: Learning to Dream with Open Minds](/articles/the-ethereum-project/)" on the Ethereum Foundation Blog (July 14, 2014), articulating the project's ethos:
...
- [The Ethereum Project](/articles/the-ethereum-project/) by Mihai Alisie
