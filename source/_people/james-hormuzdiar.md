...
social:
  linkedin: https://www.linkedin.com/in/james-hormuzdiar-b276778/
  twitter: https://x.com/JamshidHormuz
---

James "Jim" Hormuzdiar is the CTO and co-founder of [BlockApps](https://blockapps.net) and the primary architect of the Haskell Ethereum client. A physics PhD with deep Haskell expertise, he built one of Ethereum's alternative client implementations and contributed to the enterprise blockchain movement.
...
When Ethereum launched in August 2015, Jim and [Kieren](/people/kieren-james-lubin/) built physical mining rigs:
...
Meanwhile, [Victor](/people/victor-wong/) rapidly spun up cloud instances that matched their output in half an hour, demonstrating the advantages of cloud-based approaches.
...
Jim was part of the team that announced BlockApps STRATO at [DEVCON1](/articles/devcon1/) in London, alongside Microsoft's Blockchain as a Service announcement. When the Java client team pulled back from the Microsoft partnership, BlockApps stepped up to deliver:
...
This profile draws from James Hormuzdiar's appearances in the [Early Days of Ethereum Episode 1](/videos/episode001/) and [Episode 2](/videos/episode002/), which provide first-hand accounts of building the Haskell client and the enterprise Ethereum movement.
